...
function Order() {
    ...
    (async () => {
      ...
      if (cartItemId?.length > 0) {
        const cartProducts = await axios.post(
          "https://chitropot-server.vercel.app/cart",
          cartItemId
        );
  ...
  const onSubmit = (data) => {
    const total = cartItems
      .map(
        (item) =>
          parseInt(item?.price.split(",").join("")) * (item?.quantity || 1)
      )
          ...
          <Grid container spacing={20} style={{ marginTop: "20px" }}>
                ...
                <TextField
                  ...
                  {districts.map((district, index) => (
                    <MenuItem
                      key={index}
                      value={
                        district === "Please Select A District" ? "" : district
                      }>
                      {district}
                    </MenuItem>
                  ))}
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography variant='h6' paragraph>
                Yellow & Orange Color Glass Design Mosaic Turkish Jug Style
                Table Lamp <br />
                1 × ৳2,690.00 <br />
                Subtotal:{" "}
                {cartItems
              ...
              <h4>
                Pay with cash upon delivery. Outside Dhaka customer have to pay{" "}
                <br /> delivery charge in advance.
              </h4>
              <div
                style={{
                  display: "inline-block",
              ...
              <div
                ...
                <label
                  ...
                  <span style={{ fontSize: "20px" }}>
                    I have read and agree to the website terms & policy ,
                    privacy policy , return, refund & replacement policy *
                  </span>
                </label>
              </div>
            </Grid>
