...
function DetailsPage(props) {
  ...
  useEffect(() => {
    ...
    (async()=>{
      const productDetails = await axios(`https://chitropot-server.vercel.app/product/${id}`);
  ...
  useEffect(()=>{
    (async()=>{
      const {data} = await axios(`https://chitropot-server.vercel.app/category?category=${currentProduct?.categoryName}`);
  ...
  const submitReview = async (e) => {
    ...
    try {
      await axios
        .post("https://chitropot-server.vercel.app/productReviews", reviewFields)
        .then((response) => {
  ...
  const showReviews = async () => {
    try {
      await axios
        .get("https://chitropot-server.vercel.app/productReviews")
        .then((response) => {
