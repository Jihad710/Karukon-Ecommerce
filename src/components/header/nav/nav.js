                  ...
                  <li className="list-inline-item position-static">
                    ...
                    >
                      <div className="row">
                        ...
                        <div className="col">
                          <img
                            src="https://i.ibb.co/hDVPTgM/stock-photo-stylish-interior-of-room-with-sofa-and-beautiful-protea-flower-on-wall-2121636440-transf.jpg"
                            className="w-100"
                          />
                        </div>
                      </div>
            ...
            <div className="col-sm-2 part3 d-flex align-items-center">
              <div className="phNo d-flex align-items-center ml-auto">
                ...
                <div className="info ml-3">
                  <h3 className="text-g mb-0">0177323 9086</h3>
